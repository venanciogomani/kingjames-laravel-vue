    ...
    <div class="header-top">
        <div class="container">
            <div class="header-left">
                <router-link to="tel:+270810292775"><i class="icon-phone"></i>Call: +27 081 029 2775 </router-link>
            </div><!-- End .header-left -->
...
export default {
    components: {
        LanguegeSwitcher : () => import('./LanguegeSwitcher'),
        StickyHeader  : () => import('./StickyHeader'),
        AuthModal  : () => import('./Login'),
    },
    computed:{
